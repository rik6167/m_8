...
class Bvb_Grid_Template_Table_Table
{
    ...
    function pagination()
    {
        ...
        <div style=\"float:left;text-align:center;width:570px;\"> <em>({{numberRecords}} " . $this->__ ( 'records' ) . ")</em>  | {{pagination}}</div>
    ...
    function formHeader ()
    {
        return "<th style=\"width:120px;\">" . __ ( 'Nome' ) . "</th><th>" . __ ( 'Valor' ) . "</th>";
    }
