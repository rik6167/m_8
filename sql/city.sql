...
--
-- Host: localhost
-- Generation Time: Aug 20, 2014 at 11:37 PM
...
CREATE TABLE IF NOT EXISTS `city` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4082 ;
...
(4080, 'Darwin', 'AUS', 'NT', 71347),
(4081, 'Alice Springs', 'AUS', 'NT', 24640);
